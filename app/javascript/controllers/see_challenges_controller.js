...
export default class extends Controller {
    connect() {
        ...
        const panel = this.element.querySelector('.challenges-list-panel');
    ...
    close(event) {
        ...
        if (event && event.target.closest('.challenges-list-panel') &&
            !event.target.closest('[data-action*="challengeslist#close"]')) {
            return;
        }
    ...
    startDrag(event) {
        ...
        const panel = this.element.querySelector('.challenge-list-panel');
